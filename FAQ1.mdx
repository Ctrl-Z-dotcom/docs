...
<Tip>
 IF YOUR SESSION (ONLINE OR FACE-TO-FACE, GROUP OR 1:1) IS NOT CONDUCTED BECAUSE NONE OF THE LEARNERS ATTENDED, DO NOT MARK IT AS COMPLETE ON TUTOR CRUNCHER. PLEASE DO NOT WRITE A REPORT FOR SUCH SESSIONS. MARK THEM AS CANCELLED ON TUTOR CRUNCHER.
</Tip>
...
<Warning>
 FOR ALL 1:1 ALTERNATIVE PROVISION SESSIONS, TUTORS MUST LET THE ACCOUNT MANAGER KNOW ABOUT ANY ABSENCES, THEIRS OR THE LEARNER'S. 
</Warning>

<Warning>
 IF A LEARNER MISSES A SESSION IN AN EXTERNAL VENUE, INFORM EM TUITION ASAP. IT CONSTITUTES A SAFEGUARDING CONCERN.
</Warning>
