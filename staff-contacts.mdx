...
---
####Is there immediate risk to you or the child?
<Warning>
  If a child or a tutor is at **immediate risk**, call emergency services first. Then notify EM Tuition DSL on 01992 637336.
</Warning>
---
**_Communication is essential in this role, as we are dealing with a number of stakeholders. This will be more than you might be used to as a class teacher or a private tutor. Where there are multiple stakeholders, it is easy for communication channels to become blurred or misinterpreted. As such, communication must be clear, timely and effective._**
...
<CardGroup cols={2}>
  ...
  <Card title="Safeguarding" icon="umbrella">
    Concerns about the learner's safeguarding or your safety/wellbeing in the role.<br/>When in doubt - contact your Contract Manager first and ask for advice.<br/><br/>
...
<CardGroup cols={2}>
  ...
  <Card title="Finance" icon="credit-card">
    Faced any issues with your pay? If your pay doesn't match the conducted sessions on TutorCruncher (our online platform), contact our Finance Team.<br/><br/>
